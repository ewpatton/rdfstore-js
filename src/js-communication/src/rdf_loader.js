...
RDFLoader.RDFLoader = function (params) {
    ...
    this.parsers = {"text/turtle":N3Parser.parser, "text/n3":N3Parser.parser, "application/ld+json":JSONLDParser.parser, "application/json":JSONLDParser.parser, "application/rdf+xml":RDFXMLParser.parser, "text/xml":RDFXMLParser.parser, "application/xml":RDFXMLParser.parser};
    if (params != null) {
